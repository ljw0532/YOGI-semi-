...
input.yourId{
	...
	width:192px; height:38px; padding-left: 220px;
	font-size:28pt;
	background-image:url('members/findForm/yourId.png');
	border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;
}
.oops{
...
<div class="whiteForm">
	<s:if test="chk==0">
		<input class="yourId" type="text" value="${find_Id}" readonly>
		<input class="next" style="position:relative; left:10px; top:250px;" type="button" onclick="location.href='first.action'">
	</s:if>
	<s:else>
		<div class="oops"></div>
