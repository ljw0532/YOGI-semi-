...
.register{
	...
	background-image:url('members/membersForm/registerForm.png');
	border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;
}
.area{
...
input.ck{
	...
	background-image:url('members/membersForm/chkBtn.png');
	border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;
	cursor:pointer
}
input.pw{
...
input.sign{
	...
	background-image:url('members/membersForm/signUp.png');
	border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;
	cursor:pointer
}
</style>
...
<div class="register">
	<input class="id" type="text" name="m_id" id="m_id" maxlength="23">
	&nbsp;&nbsp;&nbsp;
	<input class="ck" type="button" onclick="openConfirmId(this.form)"/>
	...
	<input class="name" type="text" name="m_name" id="m_name"  maxlength="9">
	<input class="phone" type="text" name="m_phone" id="m_phone" placeholder="ex) 010-1234-1234"  maxlength="13">
</div>
...
<div class="area">
	...
	<input type="checkbox" style="margin-left:40px;" name="m_fav_area" value="성동구">성동구<br>
...
<center>						
<input class="sign" type="button" onclick="insert()">
</center>
</form>
</div>
</body>
